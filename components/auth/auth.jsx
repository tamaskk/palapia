    ...
    return (
        <Fragment>
            <Head>
                ...
                <meta name="description" content="Login and Register page of the Palapia cuisine social media" />
                <meta name="viewport" content="width=device-width, initial-scale=1" />
            </Head>
            <div>
                {
                    isLogin &&
                    <article className="w-screen min-h-full flex-grow  py-5 overflow-y-auto overflow-x-hidden lg:overflow-hidden bg-[#F1EFEF] pt-20 px-2 lg:px-20">
                        ...
                        <h1 className="text-4xl font-semibold text-center mb-10 lg:hidden">Login</h1>
                        <form
                            onSubmit={formHandler}
                            className="flex flex-col-reverse items-center justify-around lg:max-w-full xl:max-w-[1200px] h-full mx-auto lg:flex-row lg:justify-around"
                        >
                            <div className="">
                            ...
                            <div className="grid grid-cols-1 w-full md:w-1/3 gap-8 mb-8 lg:mb-0 px-5 lg:px-0">
                                <Input
                                    ...
                                    label="Email address"
                                    type="email"
                                    ownStyleLabel="text-2xl font-semibold w-full md:w-auto text-center lg:text-left mt-5 mb-2"
...
{/* <article className="w-screen h-auto pt-10 overflow-scroll lg:overflow-hidden px-6 lg:px-20 max-w-[95%] mx-auto">
<div className="h-full mx-auto flex flex-col lg:flex-row items-center justify-start lg:justify-center max-w-[95%] xl:max-w-[1200px] gap-12">
    <div className="flex flex-col items-center justify-center gap-10">
    <div className="block mx-auto w-full md:w-[300px] lg:w-[400px] h-auto md:h-[300px] lg:h-[400px] mb-5">
    <Image
        src="/images/logo.png"
        alt="logo"
        width={500}
