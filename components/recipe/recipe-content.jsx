    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const user = data.users.find(user => user.email === recipe.userEmail);
                if (user) {
    ...
    return (
        <Fragment>
            ...
            <div className="w-full h-full lg:max-w-[90%] xl:max-w-[95%] flex flex-col items-center justify-between gap-4 mt-2 px-5">
                ...
                <h1 className='text-5xl lg:text-6xl font-bold text-center flex flex-col gap-4 justify-center items-center'>
                    {recipe.name} <span className='text-4xl font-normal'> by {name}</span>
                </h1>
                ...
                <div className='flex flex-row items-start justify-center gap-10 mb-10'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-4'>
                        ...
                        <p className='text-lg text-gray-600'>{recipe.difficulity}</p>
                    </div>
                </div>
